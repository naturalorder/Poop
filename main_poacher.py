...
fig, (ax1) = plt.subplots(nrows=1,ncols=1, figsize=(8,8), dpi=70, facecolor='w', edgecolor='k')
plt.close()
...
line1, = ax1.plot([], [], 'rd', markersize = 8, markeredgecolor="black", alpha = 0.5)
...
boxes = bsim.boxes()
boxes.number_of_boxes = 2
bsim.poaching.hover = True
...
def animate(i):
    ...
    return (line, line1, time_text, box_text)#, box_line,)
...
anim.save('sim_animation_poacher.mp4', writer='ffmpeg', fps=150, dpi=200)